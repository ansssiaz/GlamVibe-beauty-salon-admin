...
interface AdministratorNetworkRepository {
    suspend fun register(administrator: NewAdministrator): AdministratorResponse
    ...
    suspend fun getProfileInformation(refreshToken: String): AdministratorResponse
    suspend fun updateProfileInformation(id: Int, newAdministrator: UpdatedAdministrator): AdministratorResponse
}